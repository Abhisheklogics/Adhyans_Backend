...
import {datasave,getRes,datasave2,homeImages,getHomeImages,EspData,getEspData,oneObject,searchArduinoData} from "../controllers/AllExperiments.controllers.js";
...
router.route('/homeData').get(getHomeImages)
...
router.route('/getDataArduino1').get(searchArduinoData)
